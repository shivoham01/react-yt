  ...
  return (
    <div className="parent">
      {jobOpenings.map((jobs, idx) => {
        return <div key={idx}>
          <Card brandLogo={jobs.brandLogo} companyName={jobs.companyName} datePosted={jobs.datePosted} post={jobs.post} tag1={jobs.tag1} tag2={jobs.tag2} location={jobs.location} pay={jobs.pay} />
        </div>
      })}
    </div>
  )
